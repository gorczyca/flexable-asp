...
APPROACHES = {
    ...
    'assumptions+con': Approach('assumptions+constraints', '/home/piotr/Dresden/multishot/results-bak/assumptions_constr.csv'),
    'externals+con': Approach('externals+constraints', '/home/piotr/Dresden/multishot/results-bak/externals_constr.csv'),
    'assumptions': Approach('assumptions', '/home/piotr/Dresden/multishot/results-bak/assumptions_noconstr.csv'),
    'externals': Approach('externals', '/home/piotr/Dresden/multishot/results-bak/externals_noconstr.csv')
