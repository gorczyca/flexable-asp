...
class CustomControl(clingo.Control):
    def __init__(self, forget_strategy, *asp_files):
        super().__init__(['--warn=none', f'--forget-on-step={forget_strategy}'])
...
def get_flex_asp_answer(instance, goal, forget_strat, timeout):
    start_time = time.time()
    ctrl = CustomControl(forget_strat, instance, ENCODING)
