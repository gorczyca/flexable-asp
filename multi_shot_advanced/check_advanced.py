...
from flexaspMSAdv import get_flex_asp_answer
...
OUTPUT_PATH = 'multi_shot_adv_{}.csv'
...
if __name__ == '__main__':
    ...
    with alive_bar(total_size, dual_line=True, title=f'Testing flexABleASP Multi-Shot ') as bar:
        for i, (index, row) in enumerate(corr_results_df.iterrows(), start=1):
            ...
            ms_result, ms_duration, ms_steps = get_flex_asp_answer(inst_path, row.goal, forget_strat, TIMEOUT)
